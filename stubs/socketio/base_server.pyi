...
class BaseServer:
    ...
    def __init__(self, client_manager: Incomplete | None = None, logger: bool = False, serializer: str = 'default', json: Incomplete | None = None, async_handlers: bool = True, always_connect: bool = False, namespaces: Incomplete | None = None, **kwargs) -> None: ...
