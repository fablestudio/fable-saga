...
class AsyncPubSubManager(AsyncManager):
    ...
    async def emit(self, event, data, namespace: Incomplete | None = None, room: Incomplete | None = None, skip_sid: Incomplete | None = None, callback: Incomplete | None = None, **kwargs): ...
