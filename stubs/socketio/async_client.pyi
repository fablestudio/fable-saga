...
class AsyncClient(base_client.BaseClient):
    ...
    connected: bool
    async def connect(self, url, headers={}, auth: Incomplete | None = None, transports: Incomplete | None = None, namespaces: Incomplete | None = None, socketio_path: str = 'socket.io', wait: bool = True, wait_timeout: int = 1, retry: bool = False) -> None: ...
    async def wait(self) -> None: ...
    async def emit(self, event, data: Incomplete | None = None, namespace: Incomplete | None = None, callback: Incomplete | None = None) -> None: ...
