...
class Packet:
    ...
    def __init__(self, packet_type=..., data: Incomplete | None = None, namespace: Incomplete | None = None, id: Incomplete | None = None, binary: Incomplete | None = None, encoded_packet: Incomplete | None = None) -> None: ...
    def encode(self): ...
