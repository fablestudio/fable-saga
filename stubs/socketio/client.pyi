...
class Client(base_client.BaseClient):
    ...
    connected: bool
    def connect(self, url, headers={}, auth: Incomplete | None = None, transports: Incomplete | None = None, namespaces: Incomplete | None = None, socketio_path: str = 'socket.io', wait: bool = True, wait_timeout: int = 1, retry: bool = False) -> None: ...
    def wait(self) -> None: ...
    def emit(self, event, data: Incomplete | None = None, namespace: Incomplete | None = None, callback: Incomplete | None = None) -> None: ...
