...
class InstrumentedAsyncServer:
    ...
    def __init__(self, sio, auth: Incomplete | None = None, namespace: str = '/admin', read_only: bool = False, server_id: Incomplete | None = None, mode: str = 'development', server_stats_interval: int = 2) -> None: ...
