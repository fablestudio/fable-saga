...
class BaseClient:
    ...
    def __init__(self, reconnection: bool = True, reconnection_attempts: int = 0, reconnection_delay: int = 1, reconnection_delay_max: int = 5, randomization_factor: float = 0.5, logger: bool = False, serializer: str = 'default', json: Incomplete | None = None, handle_sigint: bool = True, **kwargs) -> None: ...
